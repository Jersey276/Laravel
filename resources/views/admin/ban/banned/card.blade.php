...
<td class="d-flex flex-row">
    ...
    <form method="post" action="{{ $user->adminBannedLink(true) }}">
        @csrf
        @method('put')
        <button type="submit" class="link-warning border-0 bg-transparent" value="Supprimer"  data-bs-toggle="tooltip" data-bs-placement="top"  title="{{__('Débannir l\'utilisateur')}}">
